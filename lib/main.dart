import 'package:firebase_Auth/screen/home_screen.dart';
import 'package:firebase_Auth/screen/reset_password_screen.dart';
import 'package:firebase_Auth/services/auth_service.dart';
import 'package:firebase_Auth/widgets/login_form.dart';
import 'package:firebase_Auth/widgets/register_form.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        Center(child: CircularProgressIndicator()) :
        snapshot.hasData ? HomeScreen(snapshot.data as User) : MainScreen(),
          routes: {
